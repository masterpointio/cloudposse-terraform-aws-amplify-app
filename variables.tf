...
variable "job_config" {
  ...
  description = "The job configuration for the Amplify app. Allows configuration of build compute instance type. Valid values: STANDARD_8GB, LARGE_16GB, and XLARGE_72GB. Default without explicit setting is STANDARD."
  default     = null
}
